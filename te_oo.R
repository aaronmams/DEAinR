...
# slack   --> logical.  Indicates whether slack should be included.  If slack=T then the two stage model is solved
#                       where efficiency is estimated in the first stage then the sum of slacks is maximized in 
#                       the second stage.  DMU's input/output combination is Pareto efficient if the sum of slacks
#                       is 0.
...
# z       --> Matrix.  Columns are the same as those for the matrix te except there are additional columns for
#                     the sum of slack values.
